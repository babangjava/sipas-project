...
public class StokBarangController {
    ...
    public String simpan(@Valid @ModelAttribute("stokBarang") StokBarang stokBarang , BindingResult errors, SessionStatus status) {
        ...
        List<StokBarang> findTransBefore = stokBarangRepository.findByNamaGudangAndNamaBahanContainingIgnoreCaseOrderByTglTransaksiDescIdDescIdDesc(stokBarang.getNamaGudang(),stokBarang.getNamaBahan());
